...
img2 = cv.imread('5/images/img2.jpg')
img3 = cv.imread('5/images/img3.jpg')
img4 = cv.imread('5/images/img4.jpg')
img5 = cv.imread('5/images/img5.jpg')
...
cv.rectangle(mask, (x,y), (x+128, y+128), (255,255,255), -1)
